...
python3 /home/leucine/Downloads/menv-server-master-main/renum.py $1
...
rm pythonresults.txt result.pdb uniqueresult.pdb
...
python3 /home/leucine/Downloads/menv-server-master-main/renumCrd.py $2
...
python3 /home/leucine/Downloads/menv-server-master-main/residuesremoval.py
...
rm menvfilewithnum.txt output.txt revisedoutput.txt requiredoutput.txt finalfinal.txt finalresult.txt

rm totalresidues.txt  finalresultwithnum.txt
...
rm  finalappended.menv
rm finalcut.menv commaremoved.menv Menvresults.txt
#rm combined.txt uniqueMenvresidues.txt outfile.txt uniqueresidues.txt

#python /home/leucine/Downloads/menv-server-master-main/plotting.py "$filename"-new.menv
